...
<div class="signup-form">
    <form action="<?php echo e(url('login-now')); ?>" method="post" id="login-script-form">
        <?php echo csrf_field(); ?>

        <center><img src="<?php echo e($cdnLink); ?><?php echo e($company_logo); ?>" style="height: 60px;"></center>
        <hr>
        <?php if($errors->any()): ?>
            <div class="alert alert-danger"><strong>Error!</strong> <?php echo e($errors->first()); ?>.</div>
        <?php endif; ?>
                ...
                <div class="col">
                    ...
                    <?php if($errors->has('password')): ?>
                        <span class="help-block"><strong
                                    style="color: red"><?php echo e($errors->first('password')); ?></strong></span>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <div class="text-center">Don't have an account? <a href="<?php echo e(url('sign-up')); ?>">Sign Up</a></div>
</div>
...
</html><?php /**PATH C:\Users\pc\Desktop\mars-pay\resources\views/auth/login.blade.php ENDPATH**/ ?>