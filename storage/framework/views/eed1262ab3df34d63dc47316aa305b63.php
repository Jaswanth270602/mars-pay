...
<script>
    ...
    function showGraph() {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo e(url('admin/dashboard-chart-api')); ?>",
            data: dataString,
    ...
    function dashboard_details() {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo e(url('admin/dashboard-details-api')); ?>",
            data: dataString,
            success: function (msg) {
    ...
    function getServiceWiseSale() {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo e(url('admin/get-service-wise-sales')); ?>",
            data: dataString,
            success: function (msg) {
...
<div class="main-content-body">
         ...
         <?php echo $__env->make('common.dashboard_popup', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 24px; max-width: 1200px; margin: 0 auto; margin-bottom: 20px !important;">
  ...
  >
    ...
    <div data-content style="position: absolute; inset: 0; background: linear-gradient(135deg, #ed8936, #dd6b20); color: #fff; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 25px; text-align: center; opacity: 0; transition: all 0.4s ease;">
      ...
      <a href="<?php echo e(url('admin/all-user-list')); ?>" style="font-size: 13px; padding: 6px 12px; background: rgba(255,255,255,0.15); color: white; text-decoration: none; border-radius: 20px; transition: all 0.3s ease;"
  ...
  >
    ...
    <div data-content style="position: absolute; inset: 0; background: linear-gradient(135deg, #e53e3e, #c53030); color: #fff; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 25px; text-align: center; opacity: 0; transition: all 0.4s ease;">
      ...
      <a href="<?php echo e(url('admin/suspended-users')); ?>" style="font-size: 13px; padding: 6px 12px; background: rgba(255,255,255,0.15); color: white; text-decoration: none; border-radius: 20px; transition: all 0.3s ease;"
         onmouseover="this.style.background='rgba(255,255,255,0.3)'" 
            ...
            <div class="card">
                ...
                <div class="card-body p-0 m-scroll mh-350 mt-2">
                    <div class="list-group projects-list">
                        ...
                        <?php $__currentLoopData = App\Models\Loginlog::where('user_id', Auth::id())->orderBy('id', 'DESC')->paginate(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(url('admin/activity-logs')); ?>" class="list-group-item list-group-item-action flex-column align-items-start border-top-0">
                            <div class="d-flex w-100 justify-content-between">
                                <h6 class="mb-1 font-weight-semibold "><?php echo e($value->get_device); ?> - <?php echo e($value->get_browsers); ?> - <?php echo e($value->get_os); ?></h6>
                                <small class="text-danger"><?php echo e(\Carbon\Carbon::parse($value->created_at)->diffForHumans()); ?></small>
                            </div>
                            <p class="mb-0 text-muted mb-0 tx-12">IP Address: <?php echo e($value->ip_address); ?></p>
                            <small class="text-muted">Latitude: <?php echo e($value->latitude); ?>, Longitude: <?php echo e($value->longitude); ?></small>
                        </a>
...
<?php echo $__env->make('admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Desktop\mars-pay\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>