<script type="text/javascript">
    function view_recharges(id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('admin/report/v1/view-recharge-details')); ?>",
            data: dataString,
            success: function (msg) {
                ...
                if (msg.status == 'success') {
                    ...
                    $("#update_recharge_anchor").attr('onclick', msg.details.update_recharge_anchor);
                    $("#update_logs_anchor").attr('onclick', msg.details.update_logs_anchor);
    ...
    function update_recharge_refund() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('admin/report/v1/recharge-update-for-refund')); ?>",
            data: dataString,
            success: function (msg) {
    ...
    function view_transaction_logs(id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('admin/report/v1/view-transaction-logs')); ?>",
            data: dataString,
            success: function (msg) {
                $(".loader").hide();
                $("#view_recharge_model").modal('hide');
    ...
    function download_report() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('admin/download/v1/file-download')); ?>",
            data: dataString,
            success: function (msg) {
                $("#download_btn").show();
    ...
    function findIpLocation (){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('admin/report/v1/find-ip-location')); ?>",
            data: dataString,
            success: function (msg) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="refund_txnid" class="form-control" placeholder="Txnid">
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-slideout" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="form-body">
                    <div class="row">
                        ...
                        <?php if(Auth::User()->role_id <=  2): ?>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="view_api_id" disabled>
                                        <?php $__currentLoopData = $apis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value->id); ?>"><?php echo e($value->api_name); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="view_status_id" disabled>
                                    <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value->id); ?>"><?php echo e($value->status); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <?php if(Request::segment(2) == 'money-transfer-report'): ?>
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="view_ifsc" class="form-control" placeholder="IFSC Code" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="view_bank_name" class="form-control" placeholder="Bank Name" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="view_name" class="form-control" placeholder="Beneficiary Name" disabled>
                                </div>
                            </div>

                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="name">Remiter Number</label>
                                    <input type="text" id="view_remiter_number" class="form-control" placeholder="Remiter Number" disabled>
                                </div>
                            </div>

                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="name">Remiter Name</label>
                                    <input type="text" id="view_remiter_name" class="form-control" placeholder="Remiter Name" disabled>
                                </div>
                            </div>
                        <?php endif; ?>
            ...
            <div class="modal-footer">
                ...
                <?php if(Auth::User()->role_id == 2 && $permission_update_transaction == 1): ?>
                    <button class="btn btn-success" id="update_recharge_anchor"><i class="fas fa-edit"></i> Update</button>
                <?php elseif(Auth::user()->role_id == 1): ?>
                    <button class="btn btn-success" id="update_recharge_anchor"><i class="fas fa-edit"></i> Update</button>
                <?php endif; ?>
                    
                <?php if(Auth::User()->role_id == 2 && $permission_view_api_logs == 1): ?>
                    <button class="btn btn-danger" id="update_logs_anchor"><i class="fas fa-history"></i> Api Logs</button>
                <?php elseif(Auth::user()->role_id == 1): ?>
                    <button class="btn btn-danger" id="update_logs_anchor"><i class="fas fa-history"></i> Api Logs</button>
                <?php endif; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="download_menu_name" class="form-control" value="<?php echo e($report_slug); ?>" readonly>
...
</div><?php /**PATH C:\Users\pc\Desktop\mars-pay\resources\views/admin/report/transaction_refund_model.blade.php ENDPATH**/ ?>