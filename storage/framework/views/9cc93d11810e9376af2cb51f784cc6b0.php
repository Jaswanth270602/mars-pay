<style>
    ...
    .horizontalMenucontainer .main-header.hor-header {
        position: fixed;
        background: linear-gradient(45deg, <?php echo e($color_start); ?>, <?php echo e($color_end); ?>) !important; }

    .main-content:after {
        content: "";
        height: 220px;
        background: linear-gradient(45deg, <?php echo e($color_start); ?>, <?php echo e($color_end); ?>);
        position: absolute;
        z-index: -1;
        width: 100%;
        top: 0;
...
<script type="text/javascript">
    ...
    function sendAadharOtp (){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('agent/aadhaar-verification/v1/send-otp')); ?>",
            data: dataString,
    ...
    function confirmAadharOtp (){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('agent/aadhaar-verification/v1/confirm-otp')); ?>",
            data: dataString,
            success: function (msg) {
                $("#aadharBtn").show();
                $("#aadharBtn_loader").hide();
    ...
    function panVerify (){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('agent/pan-verify/v1/verify-now')); ?>",
            data: dataString,
            success: function (msg) {
                $("#panVerifyBtn").show();
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="pancard_number" class="form-control" placeholder="Pan Number" value="<?php echo e(Auth::User()->member->pan_number); ?>">
                            </div>
                        </div>
...
</div><?php /**PATH C:\Users\pc\Desktop\mars-pay\resources\views/agent/layout/style.blade.php ENDPATH**/ ?>