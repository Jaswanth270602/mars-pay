<script type="text/javascript">
    function dth_customer_info() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('agent/plan/v1/dth-customer-info')); ?>",
            data: dataString,
    ...
    function dth_plans() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('agent/plan/v1/dth-plans')); ?>",
            data: dataString,
            success: function (msg) {
                $(".loader").hide();
                if (msg.status == 'success') {
    ...
    function dth_refresh() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('agent/plan/v1/dth-refresh')); ?>",
            data: dataString,
            success: function (msg) {
                $(".loader").hide();
                if (msg.status == 'success') {
    ...
    function dth_roffer() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('agent/plan/v1/dth-roffer')); ?>",
            data: dataString,
            success: function (msg) {
                $(".loader").hide();
                if (msg.status == 'success') {
...
</div><?php /**PATH C:\Users\pc\Desktop\mars-pay\resources\views/agent/service/dth_customer_info_model.blade.php ENDPATH**/ ?>