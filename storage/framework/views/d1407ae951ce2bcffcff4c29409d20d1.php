<?php $__env->startSection('content'); ?>
    ...
    <script type="text/javascript">
        ...
        function update_details() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(url('admin/site-setting/update-settings')); ?>",
                data: dataString,
        ...
        function get_distric() {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo e(url('admin/get-distric-by-state')); ?>",
                data: dataString,
                success: function (msg) {
                    $(".loader").hide();
                    if (msg.status == 'success') {
    ...
    <input type="hidden" id="setting_id" value="<?php echo e($id); ?>">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="sms">
                                            <option value="0" <?php if($sms == 0): ?> selected <?php endif; ?>>Disabled</option>
                                            <option value="1" <?php if($sms == 1): ?> selected <?php endif; ?>>Enabled</option>
                                        </select>
                                        <ul class="parsley-errors-list filled">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="whatsapp_number" class="form-control"
                                               placeholder="Whatsapp Number" value="<?php echo e($whatsapp_number); ?>">
                                        <ul class="parsley-errors-list filled">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="whatsapp">
                                            <option value="0" <?php if($whatsapp == 0): ?> selected <?php endif; ?>>Disabled</option>
                                            <option value="1" <?php if($whatsapp == 1): ?> selected <?php endif; ?>>Enabled</option>
                                        </select>
                                        <ul class="parsley-errors-list filled">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="whatsapp_key" class="form-control"
                                               placeholder="Whatsapp Api Token" value="<?php echo e($whatsapp_key); ?>">
                                        <ul class="parsley-errors-list filled">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="alert_amount" class="form-control"
                                               placeholder="Alert Amount" value="<?php echo e($alert_amount); ?>">
                                        <ul class="parsley-errors-list filled">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="send_mail">
                                            <option value="0" <?php if($send_mail == 0): ?> selected <?php endif; ?>>Disabled</option>
                                            <option value="1" <?php if($send_mail == 1): ?> selected <?php endif; ?>>Enabled</option>
                                        </select>
                                        <ul class="parsley-errors-list filled">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="password_expires_at">
                                            <?php for($i = 1; $i < 31; $i ++): ?>
                                                <option value="<?php echo e($i); ?>" <?php if($password_expires_days == $i): ?> selected <?php endif; ?>>after <?php echo e($i); ?> days</option>
                                            <?php endfor; ?>
                                        </select>
                                        <ul class="parsley-errors-list filled">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="registration_status">
                                            <option value="0" <?php if($registration_status == 0): ?> selected <?php endif; ?>>Disabled
                                            </option>
                                            <option value="1" <?php if($registration_status == 1): ?> selected <?php endif; ?>>Enabled
                                            </option>
                                        </select>
                                        <ul class="parsley-errors-list filled">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="registration_scheme_id">
                                            <option value="0" <?php if($registration_status == 0): ?> selected <?php endif; ?>>Select
                                                Scheme
                                            </option>
                                            <?php $__currentLoopData = $schemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value->id); ?>"
                                                        <?php if($registration_scheme_id == $value->id): ?> selected <?php endif; ?>><?php echo e($value->scheme_name); ?></option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="registration_role_id">
                                            <option value="0" <?php if($registration_role_id == 0): ?> selected <?php endif; ?>>Select
                                                Member Type
                                            </option>
                                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value->id); ?>"
                                                        <?php if($registration_role_id == $value->id): ?> selected <?php endif; ?>><?php echo e($value->role_title); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <ul class="parsley-errors-list filled">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="registration_parent_id">
                                            <option value="0" <?php if($registration_parent_id == 0): ?> selected <?php endif; ?>>
                                                Select Parents
                                            </option>
                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value->id); ?>"
                                                        <?php if($registration_parent_id == $value->id): ?> selected <?php endif; ?>><?php echo e($value->name); ?> <?php echo e($value->last_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <ul class="parsley-errors-list filled">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="registration_state_id" onchange="get_distric(this)">
                                            <option value="0" <?php if($registration_state_id == 0): ?> selected <?php endif; ?>>
                                                Select State
                                            </option>
                                            <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value->id); ?>"
                                                        <?php if($registration_state_id == $value->id): ?> selected <?php endif; ?>><?php echo e($value->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <ul class="parsley-errors-list filled">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="registration_district_id">
                                            <option value="0" <?php if($registration_district_id == 0): ?> selected <?php endif; ?>>
                                                Select District
                                            </option>
                                            <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value->id); ?>"
                                                        <?php if($registration_district_id == $value->id): ?> selected <?php endif; ?>><?php echo e($value->district_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <ul class="parsley-errors-list filled">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="mail_transport" class="form-control"
                                               placeholder="Example : (mail)" value="<?php echo e($mail_transport); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="mail_host" class="form-control"
                                               placeholder="Example : (smtp.gmail.com)" value="<?php echo e($mail_host); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="mail_port" class="form-control"
                                               placeholder="Example : (587)" value="<?php echo e($mail_port); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="mail_encryption" class="form-control"
                                               placeholder="Example : (tls)" value="<?php echo e($mail_encryption); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="mail_username" class="form-control"
                                               placeholder="Mail Username" value="<?php echo e($mail_username); ?>">
                                        <ul class="parsley-errors-list filled">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="password" id="mail_password" class="form-control"
                                               placeholder="Password" value="<?php echo e($mail_password); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="mail_from" class="form-control"
                                               placeholder="noreply@domain.com" value="<?php echo e($mail_from); ?>">
                                        <ul class="parsley-errors-list filled">
...
<?php echo $__env->make('admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Desktop\mars-pay\resources\views/admin/site_settings.blade.php ENDPATH**/ ?>