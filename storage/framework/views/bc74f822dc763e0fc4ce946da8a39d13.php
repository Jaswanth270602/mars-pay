...
<section>
    <div class="container cwp4-two">
        <div class="cwp4-text">
            <h3>Welcome to <?php echo e($company_name); ?></h3>
            <p><?php echo e($company_name); ?> is an online Portal developed to create a B2B Business System for retailers.</p>
        ...
        <div class="cwp4-image">
            <img src="<?php echo e(url('front/images/about-img.png')); ?>" alt="About Image">
        </div>
    </div>
</section>
...
<?php echo $__env->make('front.template1.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Desktop\mars-pay\resources\views/front/template1/welcome.blade.php ENDPATH**/ ?>