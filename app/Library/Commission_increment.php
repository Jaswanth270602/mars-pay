            ...
            if ($final_comm == 0){
                ...
                if (empty($checktxnid)){
                    ...
                    Report::insertGetId([
                        ...
                        'amount' => ($getuser->role_id == 8 || $getuser->role_id == 9 || $getuser->role_id == 10) ? $final_comm : 0,
                        'profit' => ($getuser->role_id == 8 || $getuser->role_id == 9 || $getuser->role_id == 10) ? 0 : $final_comm,
                        'api_id' => $api_id,
                        'status_id' => 6,
                        'txnid' => $insert_id,
                    ...
                    $library->send_sms($getuser->mobile, $message, $template_id);
                }
            }
        }
