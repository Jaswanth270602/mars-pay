...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function confirmSender (){
            ...
            var state = $("#state").val();
            var address = $("#address").val();
            var dataString = 'mobile_number=' + mobile_number + '&first_name=' + first_name + '&last_name=' + last_name + '&pincode=' + pincode + '&state=' + state + '&address=' + address + '&otp=' + otp + '&ad1=' + ad1 + '&ad2=' + ad2 + '&_token=' + token;
            $.ajax({
                type: "POST",
                url: "{{url('agent/money/v1/confirm-sender')}}",
                data: dataString,
                success: function (msg) {
                    $("#addSederBtn").show();
                    $("#addSederBtn_loader").hide();
        ...
        function resendOtp (){
            ...
            $.ajax({
                type: "POST",
                url: "{{url('agent/money/v1/sender-resend-otp')}}",
                data: dataString,
                success: function (msg) {
                    $("#resendOtpBtn").show();
        ...
        function verifyBeneficiary (){
            ...
            $.ajax({
                type: "POST",
                url: "{{url('agent/money/v1/confirm-beneficiary')}}",
                data: dataString,
                success: function (msg) {
        ...
        function confirmDeleteBeneficiary (){
            ...
            $.ajax({
                type: "POST",
                url: "{{url('agent/money/v1/confirm-delete-beneficiary')}}",
                data: dataString,
                success: function (msg) {
        ...
        function accountVerify() {
            ...
            if (latitude && longitude) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{url('agent/money/v1/account-verify')}}",
                    data: dataString,
                    success: function (msg) {
                        getWalletBal();
                        $(".loader").hide();
        ...
        function viewTransfer (id){
            ...
            $.ajax({
                type: "POST",
                url: "{{url('agent/money/v1/view-account-transfer')}}",
                data: dataString,
                success: function (msg) {
                    $(".loader").hide();
                    if (msg.status == 'success') {
        ...
        function SearchByAccount() {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('agent/money/v1/search-by-account')}}",
                data: dataString,
                success: function (msg) {
                    $(".loader").hide();
                    if (msg.status == 'success') {
