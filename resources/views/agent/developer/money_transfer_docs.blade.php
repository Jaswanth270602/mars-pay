            ...
            <div class="col-lg-8 col-xl-9">
                ...
                <div class="card" id="basic-alert">
                    ...
                    <div class="card-footer">
                        <pre>POST: {{url('api/dmt/v1/bank-list')}}</pre>
                        <hr>
                ...
                <div class="card" id="basic-alert">
                    <div class="card-body">
                        ...
                        <table class="table main-table-reference mt-0 mb-0">
                            ...
                            <tr>
                                <td>mobile_number</td>
                                <td>Remiter Mobile Number</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="card-footer">
                        <pre>POST: {{url('api/dmt/v1/get-customer')}}</pre>
                        <hr>
                ...
                <div class="card" id="basic-alert">
                    <div class="card-body">
                        ...
                        <table class="table main-table-reference mt-0 mb-0">
                            ...
                            <tr>
                                <td>first_name</td>
                                <td>Remiter Fist Name</td>
                            </tr>

                            <tr>
                                <td>last_name</td>
                                <td>Remiter Last Name</td>
                            </tr>

                            <tr>
                                <td>pin_code</td>
                                <td>Remiter Pin Code</td>
                            </tr>

                            <tr>
                                <td>address</td>
                                <td>Remiter Remiter Address</td>
                            </tr>
                    ...
                    <div class="card-footer">
                        <pre>POST: {{url('api/dmt/v1/add-sender')}}</pre>
                        <hr>
                ...
                <div class="card" id="basic-alert">
                    ...
                    <div class="card-footer">
                        <pre>POST: {{url('api/dmt/v1/resend-otp')}}</pre>
                        <hr>
                        <pre>Success : {"status":"success","message":"Success"}</pre>
                        <pre>Failure : {"status":"failure","message":"Sender Already Exists"}</pre>
                    </div>
                ...
                <div class="card" id="basic-alert">
                    ...
                    <div class="card-footer">
                        <pre>POST: {{url('api/dmt/v1/sender-confirmation')}}</pre>
                        <hr>
                        <pre>Success : {"status":"success","message":"Success"}</pre>
                ...
                <div class="card" id="basic-alert">
                    ...
                    <div class="card-footer">
                        <pre>POST: {{url('api/dmt/v1/get-all-beneficiary')}}</pre>
                        <hr>
                ...
                <div class="card" id="basic-alert">
                    ...
                    <div class="card-footer">
                        <pre>POST: {{url('api/dmt/v1/account-verify')}}</pre>
                        <hr>
                ...
                <div class="card" id="basic-alert">
                    ...
                    <div class="card-footer">
                        <pre>POST: {{url('api/dmt/v1/add-beneficiary')}}</pre>
                        <hr>
                ...
                <div class="card" id="basic-alert">
                    ...
                    <div class="card-footer">
                        <pre>POST: {{url('api/dmt/v1/transfer')}}</pre>
                        <hr>
                ...
                <div class="card" id="basic-alert">
                    ...
                    <div class="card-footer">
                        <pre>POST: {{url('api/dmt/v1/delete-beneficiary')}}</pre>
                        <hr>
                        <pre>Success : {"status":"success","message":"Success Message"}</pre>
                        <pre>Failure : {"status":"failure","message":"Failure Message"}</pre>
                    </div>
