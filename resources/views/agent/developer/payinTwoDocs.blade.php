            ...
            <div class="col-lg-8 col-xl-9">
                ...
                <div class="card" id="basic-alert">
                    ...
                    <div class="card-footer">
                        <pre>POST: {{url('api/add-money/v4/createOrder')}}</pre>
                        <hr>
                        <pre style="color: #0ba360;">Success Response : {"status":"success","message":"Request Completed","data":{"qrString":"upi://pay?pa=Intent-UDAY84@mairtel&pn=UDAYPAYINDIASERVICEPRIVATELIMITED&mc=5691&tr=873552305251221189&cu=INR&am=100.0&mam=100.0&mode=01&purpose=00&orgId=000000","txnid":4851}}</pre>
                        <hr>
                    </div>
                </div>
                ...
                <div class="card" id="basic-alert">
                    ...
                    <div class="card-footer">
                        <pre>POST: {{url('api/add-money/v4/status-enquiry')}}</pre>
                        <hr>
