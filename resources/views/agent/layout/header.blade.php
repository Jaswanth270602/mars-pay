        ...
        <div class="horizontal-mainwrapper container clearfix">
            ...
            <nav class="horizontalMenu clearfix">
                <ul class="horizontalMenu-list">
                   ...
                   <!-- <li  aria-haspopup="true" class="btn btn-danger"><a href="{{url('agent/referral/refer-and-earn')}}" style="color: white;">Refer & Earn</a> </li>-->

                    <li aria-haspopup="true"  class="btn btn-success">
