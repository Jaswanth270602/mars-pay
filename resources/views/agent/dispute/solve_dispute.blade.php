                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            <tr>
                                ...
                                <td>{{ $value->message }}</td>
                                <td><span class="{{ $value->status->class }}">Solve</span></td>
                                <td><button class="btn btn-danger btn-sm" onclick="view_conversation({{ $value->id }})">Chat({{App\Disputechat::where('dispute_id',  $value->id)->whereNotIn('user_id', [Auth::id()])->where('is_read', 0)->count()}})</button></td>
    ...
    <div class="modal-dialog modal-dialog-slideout" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="main-chat-footer">
                ...
                <select class="form-control" id="complaint_status"><option value="3">Re Open</option></select>
                <a class="main-msg-send" href="#" onclick="reopen_dispute()" id="send_btn">Re open</a>
