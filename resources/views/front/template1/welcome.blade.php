            ...
            <div class="container py-md-5">
                <div class="cwp4-two row">
                    ...
                    <div class="cwp4-text col-lg-6">
                        ...
                        <p>
                            {{ $company_name }} is on-line Portal developed to create a B2B Business System to enhance the chances of earning money for retailers. Following the competition we understand the business requirement of retailers and provides best rates and commission for our
                        </p>
                        <p>
                            We provides service like Bill Payments (Electricity,WATER ,LPG gas)etc.

                        </p>
                        <p>
                            On call solutions and Prompt Response is our key to service and our customer base . We are Best bill payment Service and Portal provider in PAN India.
                        </p>
                    </div>
