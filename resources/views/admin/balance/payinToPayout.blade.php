            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (msg.status == 'success') {
                        ...
                        $("#view_aeps_balance").val(msg.details.aeps_balance);
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Payin To Payout wallet</h6>
                ...
                <div class="modal-body">
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="name">Current Payout Balance</label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="name">Current Payin Balance</label>
                                    <input type="text" id="view_aeps_balance" class="form-control" placeholder="Current Payin Balance" disabled>
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    <button class="btn ripple btn-primary" type="button" id="transfer_btn" onclick="transferNow()">Transfer Now</button>
