            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('admin/money-transfer-report')}}" method="get">
                            <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="@if(Auth::User()->company->table_format == 1)table text-md-nowrap @else display responsive nowrap @endif" id="my_table">
                                ...
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">Remiter Number</th>
                                    <th class="wd-15p border-bottom-0">Remiter Name</th>
