                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" id="provider_id"  style="width: 100%;">
                                                    @foreach($providers as $value)
                                                        <option value="{{ $value->id }}" data-subtitle="Neeraj" data-left="https://cdn.bceres.com/storage/company_logo/b2c.bceres.com-1597320256.png">{{ $value->provider_name }}</option>
                                                    @endforeach
                                                </select>
